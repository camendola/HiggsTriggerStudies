...
filelist = open("fileList_HLTPhysics_run301567.txt")
...
for idx, block in enumerate(fileblocks):
    ...
    cmsRun = "cmsRun ZeroBias_noEmul.py maxEvents=-1 inputFiles_load="+outListName + " outputFile="+outRootName + " >& " + outLogName
