...
if not isMC:
    ...
    process.load('HiggsTriggerStudies.Rates.zeroBias_cff')
    process.source = cms.Source("PoolSource",
        #fileNames = cms.untracked.vstring("/store/data/Run2017B/HLTPhysics/MINIAOD/PromptReco-v1/000/297/101/00000/06603FD2-2457-E711-9D4C-02163E014329.root"
                                fileNames = cms.untracked.vstring("/store/data/Run2017C/HLTPhysics2/RAW/v1/000/301/567/00000/48066D17-2B87-E711-9E08-02163E019B86.root"                      
...
process.ZeroBias.triggerResultsLabel = cms.InputTag("TriggerResults", "", "HLT")
